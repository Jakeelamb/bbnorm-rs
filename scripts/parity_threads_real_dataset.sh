...
printf 'Running Java BBNorm deterministic normalization with threads=2 on real paired phiX fixture...\n'
...
printf 'Running Rust bbnorm-rs deterministic normalization accepting threads=2 on same fixture...\n'
...
printf 'threads=2 deterministic parity passed. Java: %sms, Rust: %sms\n' "$JAVA_MS" "$RUST_MS"
